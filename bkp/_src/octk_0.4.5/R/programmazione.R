...
init_programmazione <- function(use_temi=FALSE, use_sog=FALSE, use_eu=FALSE, use_flt=FALSE, use_713=FALSE, use_articolaz=FALSE, use_location=FALSE, use_ciclo=FALSE, tipo_ciclo="CICLO_STRATEGIA", use_en=FALSE, use_po_psc=FALSE)
{
  # use_temi = FALSE
  # use_sog=TRUE
  # use_eu=TRUE

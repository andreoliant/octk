...
setup_macroaree <- function(bimestre, progetti, operazioni_713, operazioni_1420, export=FALSE, use_fix=FALSE, debug=FALSE) {
  if (exists("DATA", envir = .GlobalEnv)) {
    ...
    macroaree <- workflow_macroaree(bimestre, progetti, operazioni_713=operazioni_713, operazioni_1420=operazioni_1420, debug=debug)
...
workflow_macroaree <- function(bimestre, progetti, operazioni_713, operazioni_1420, riprop_yei=FALSE, debug=FALSE) {
